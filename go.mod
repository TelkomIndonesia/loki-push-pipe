module github.com/telkomindonesia/loki-push-pipe

go 1.20

require (
	github.com/grafana/loki v1.6.2-0.20230503105729-c7cb07796fe0
	github.com/grafana/loki/pkg/push v0.0.0-20230503105729-c7cb07796fe0
)
...
// BEGIN Replace https://github.com/grafana/loki/blob/v2.8.1/go.mod#LL315C1-L334C98
